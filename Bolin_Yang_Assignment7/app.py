...
# The mandatory additionals show book by author
@app.route("/book-by-author", methods=["GET"])
def by_author():
...
def all_authors():
    ...
    return render_template("all_authors.html", categories=categories, authors=authors)
